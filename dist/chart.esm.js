...
function (_ChartComponent) {
  ...
  _createClass(ModuleNicar2019Chart, [{
    ...
    value: function draw() {
      ...
      var height = 500;
      this.selection().appendSelect('h2', 'state-name').html('Unemployment in ' + stateData.State);
      var lineData = [];
      ...
      months.map(function (month) {
        years.map(function (year) {
          lineData.push({
            ...
            'value': stateData["".concat(month, "-").concat(year)]
          });
        });
      });
      ...
      g.appendSelect('path', 'data-line').datum(lineData).attr('d', line).style('stroke', props.strokeColor);
      return this;
    }
  }]);
